<template>
  <div class="layout-full layout-v">
    ...
    <div class="layout-fill container">
      <div class="gutter-v">
        <el-alert title="录入数据必然存在谬误和缺失，所以数据仅能作为参考，不能作为最终结论。感兴趣的比赛可前往b站/斗鱼scboy根据日期观看录像。" type="error"></el-alert>
        <el-alert title="默认统计包含对黑(方便查看最新比赛情况，非加赛阶段换人，此两人的胜负不计入比赛场次)，正赛统计数据您可在上方选择比赛类型进行筛选。~~数据更新至2023年5月16日(次日或周末更新)" type="error"></el-alert>
      </div>
